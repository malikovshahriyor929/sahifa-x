    ...
    <div className="flex flex-col gap-6">
      <section className="rounded-2xl border border-primary-light/25 bg-white p-6 shadow-sm">
        ...
        {topAuthors.length > 0 ? (
          ...
          <div className="rounded-xl border border-dashed border-primary-light/30 bg-primary/5 px-4 py-5 text-sm text-dark-900/60">
            Mualliflar statistikasi hali yetarli emas.
          </div>
        )}
      </section>
      ...
      <section className="rounded-2xl border border-primary-light/25 bg-white p-6 shadow-sm">
        ...
        {topGenres.length > 0 ? (
          ...
          <div className="rounded-xl border border-dashed border-primary-light/30 bg-primary/5 px-4 py-5 text-sm text-dark-900/60">
            Janrlar bo&apos;yicha ma&apos;lumot hozircha mavjud emas.
          </div>
        )}
      </section>
    </div>
